    ...
    >
      <div className="flex justify-center items-center gap-2">
        <motion.a
          ...
          className="relative inline-flex items-center justify-center gap-2 bg-github text-white px-4 py-2 rounded-lg transition-colors whitespace-nowrap text-sm font-medium border border-github hover:bg-github-darker flex-1"
        ...
        <motion.button
          onClick={copyLink}
          className="relative inline-flex items-center justify-center gap-2 bg-discord text-white px-4 py-2 rounded-lg transition-colors whitespace-nowrap text-sm font-medium border border-discord hover:bg-discord-darker flex-1"
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
