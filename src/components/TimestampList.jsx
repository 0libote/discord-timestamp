    ...
    >
      {timestampTypes.map((type) => {
        ...
        return (
                              <motion.div
                                key={type.id}
                                className="bg-discord-50/50 dark:bg-discord-900/50 rounded-2xl p-4 md:p-5 shadow-lg border border-gray-200 dark:border-gray-700 transition-all duration-300"
